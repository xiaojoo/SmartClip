...
Rectangle {
    ...
    readonly property color mutedColor: Theme.c("#77808c", Theme.rev)
    readonly property color textColor:  Theme.c("#7d7d7d", Theme.rev)
    ...
    RowLayout {
        ...
        Label {
            ...
            color: root.hasDoc ? Theme.c("#bbbbbb", Theme.rev) : root.textColor
            font.pixelSize: 11
            Layout.alignment: Qt.AlignVCenter
        ...
        Info {
            ...
            color: Theme.c("#9aa0a8", Theme.rev)
        }
